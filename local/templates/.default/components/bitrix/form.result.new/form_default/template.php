        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <?php if ($FIELD_SID === "vacant") {?>
                            <td id="vacat-wrapper" ><?= $arQuestion["HTML_CODE"] ?></td>
                         <? } else { ?>
                            <td ><?= $arQuestion["HTML_CODE"] ?></td>
                        <?php  } ?>
                        <script>
                            window.addEventListener("DOMContentLoaded", (event) => {
                                document.getElementById('vacat-wrapper').querySelector('input').value = '<?php echo $arParams["ELEMENT_ID"] ?>'
                            });
                        </script>
                    </tr>
            <?
